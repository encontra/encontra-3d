...
import pt.inevo.encontra.threed.viewer.menus.MenuFactory;
...
public class ModelViewer implements GLEventListener {
	...
	public ModelViewer(int width, int height, Model model) {
        ...
        menuBar.add(MenuFactory.createMenu(MenuFactory.MenuType.File));
        menuBar.add(MenuFactory.createMenu(MenuFactory.MenuType.View));
        menuBar.add(MenuFactory.createMenu(MenuFactory.MenuType.Windows));
        menuBar.add(MenuFactory.createMenu(MenuFactory.MenuType.Help));
